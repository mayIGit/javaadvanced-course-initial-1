 ...
 *     element. Here the one element is considered as sorted.
...
public class MyMergeSort {
     ...
     * efficiency. When sorting arrays, merge sort requires additional scratch 
     * space proportional to the size of the input array. Merge sort is relatively 
     * simple to code and offers performance typically only slightly below that 
     * of quicksort.
     */
